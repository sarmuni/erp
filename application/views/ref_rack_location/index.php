        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="dataTable" class="table table-bordered table-hover display" style="width:100%">
                    ...
                    <?php
                    $no = 1;
                    foreach ($ref_rack_location as $row) {
                    ?>
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td><?php echo strtoupper($row['name']); ?></td>
                            <td><?php echo strtoupper($row['gln_rl']); ?></td>
...
<!-- Modal Add -->
<div class="modal fade tambah_ref_rack_location" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form Add Master Rack Location</h5>
            ...
            <div class="modal-body">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        <form autocomplete="off" action="<?php echo base_url('ref_rack_location/add'); ?>" method="POST" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <?= form_error('area_room_id', '<p style="color:red; font-size:12px;">', '</p>'); ?>
                                </div>
...
<!-- Modal Edit -->
<?php
foreach ($ref_rack_location as $i) :
    $id                         = $i['id'];
    $area_room_id               = $i['area_room_id'];
    $name                       = $i['name'];
    $description                = $i['description'];
?>
    <div class="modal fade edit_ref_rack_location" id="edit_ref_rack_location<?php echo $id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form autocomplete="off" action="<?php echo base_url('ref_rack_location/edit/' . $id); ?>" method="POST" enctype="multipart/form-data">
                                <div class="form-row">
