                        ...
                        <form autocomplete="off" action="<?php echo base_url('kurir/add'); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="negara" required class="form-control" id="negara" value="<?= set_value('negara'); ?>">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" name="hp" class="form-control" required id="hp" value="<?= set_value('hp'); ?>">
