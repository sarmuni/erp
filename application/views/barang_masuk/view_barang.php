...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <?php } ?>
        <a role="button" href="<?php echo base_url('barang_masuk'); ?>" class="btn bg-danger" title="Kembali">
            <i class="fas fa-chevron-circle-left"></i>
        </a>
        <?php if ($user['role_id'] == 1) { ?>
            <a role="button" href="<?php base_url('barang_masuk'); ?>" class="btn bg-danger" title="Refresh">
                <i class="fas fa-sync-alt"></i>
            </a>
            <a role="button" href="<?php echo site_url(); ?>barang_masuk/in_kargo/<?php echo $row['no_resi']; ?>" id="in-kargo" class="btn bg-info in-kargo" title="Kirim Ke Indonesia">
                <i class="fas fa-clipboard-check"> Kirim Indonesia</i>
            </a>
        <?php } ?>
        <hr>
