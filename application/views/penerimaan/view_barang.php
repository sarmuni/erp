...
<div class="card mb-3">
    ...
    <div class="card-body">
        ...
        <?php if ($user['role_id'] == 1 or $user['role_id'] == 3) { ?>
            ...
            <a role="button" href="<?php echo site_url(); ?>penerimaan/kirim_gudang/<?php echo $row['no_resi']; ?>" id="kirim-gudang" class="btn bg-info kirim-gudang" title="Kirim Ke Gudang">
