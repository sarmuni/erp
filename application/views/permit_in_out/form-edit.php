...
<form autocomplete="off" action="<?php echo base_url('permit_in_out/edit'); ?>/<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
<div class="col-12">
    <div class="card mb-3">
        ...
        <div class="flash-data-required" data-flashdata="<?= $this->session->flashdata('required'); ?>"></div>
            ...
            <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                        <input type="date" name="permit_date" class="form-control form-control-sm" id="permit_date" value="<?php echo $permit_date; ?>">
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                        <textarea type="text" id="necessity" name="necessity" class="form-control"><?php echo $necessity; ?></textarea>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-2">
                        <input type="time" id="time" class="form-control form-control-sm" name="time" value="<?php echo $time; ?>">
                        </div>
