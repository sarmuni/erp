...
<div class="col-12">
    <div class="card mb-3">
        ...
        <div class="card-body">
            <a role="button" href="<?php echo base_url('inventaris/form'); ?>" class="btn bg-danger btn-sm" title="Add">
                <i class="fas fa-user-plus"></i> Add New
            </a>

            <a role="button" href="#" class="btn bg-danger btn-sm" title="Print">
                <i class="fas fa-print"></i> Generate Label
            </a>

            <a role="button" href="<?php echo base_url('inventaris'); ?>" class="btn bg-danger btn-sm" title="Refresh">
            ...
            <div class="table-responsive">
                <table id="dataTable" class="table table-bordered table-hover display" style="width:100%">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Number Inventaris</th>
                            <th>Receipt Date</th>
                            <th>Category</th>
                            <th>Name Inventaris</th>
                            <th>Departements</th>
                            <th>Action</th>
                        </tr>
                    </thead>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a role="button" href="#" class="btn bg-warning btn-sm" title="Edit" data-toggle="modal" data-target="#edit_inventaris<?php echo $row['id']; ?>"><i class="fas fa-user-edit"></i>
                                </a>
                                
                                 <a role="button" href="<?php echo site_url(); ?>inventaris/delete/<?php echo $row['id']; ?>" id="deleted" class="btn bg-danger btn-sm tombol-hapus" title="delete record"><i class="fas fa-trash-alt"></i>
                                 </a>
...
<!-- Modal Add -->
<div class="modal fade tambah_inventaris" tabindex="-1" role="dialog" aria-hidden="true">
...
?>
    <div class="modal fade edit_inventaris" id="edit_inventaris<?php echo $id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form autocomplete="off" action="<?php echo base_url('inventaris/edit/' . $id); ?>" method="POST" enctype="multipart/form-data">
                                <div class="form-row">
