                ...
                <table id="dataTable" class="table table-bordered table-hover display" style="width:100%">
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <?php if ($row['in_kargo'] == 1) { ?>
                                        <button type="button" class="btn btn-outline-success mb-2">In Kargo</button>
                                    <?php } else { ?>
                                        <a role="button" href="<?php echo site_url(); ?>barang_masuk/view_barang/<?php echo $row['no_resi']; ?>" class="btn bg-danger" title="Lihat Barang"><i class="fab fa-searchengin"></i>
                                        </a>
                                    <?php } ?>
                                </center>
                            </td>
