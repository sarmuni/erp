                ...
                <div class="col-md-6 contents">
                    <div class="row justify-content-center">
                        <div class="col-md-8">
                            ...
                            <!-- <img src="<?= base_url(); ?>assets/template_neura/images/BIG-warehouse.png" alt="Image" class="img-fluid"> -->
                            ...
                            <form action="<?= base_url('auth'); ?>" method="post">
                                ...
                                <button type="submit" value="Log In" class="btn btn-block btn-primary" style="background-color: red;">Log In</button>

                                <span class="d-block text-center my-4 text-muted">Don't have an account yet <a href="<?= base_url('auth/registration'); ?>"> Registrasion! </a></span>
