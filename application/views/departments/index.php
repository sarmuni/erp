...
<div class="col-12">
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <a role="button" href="<?php base_url('departments'); ?>" class="btn bg-danger" title="Refresh">
                ...
                <table id="dataTable" class="table table-bordered table-hover display" style="width:100%">
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo number_format($row['budgetLimit'],2); ?></td>
                            <td>0.00</td>
                            <td>0.00</td>
                            <td><?php echo $row['departmentEmail']; ?></td>
                            <td><?php echo $row['budgetStartDate']; ?></td>
                            <td><?php echo $row['budgetEndDate']; ?></td>
                            <!-- <td>
