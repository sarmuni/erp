                ...
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul class="list-unstyled">
                            ...
                            <li>
                                <a <?php echo $this->uri->segment(1) == 'ref_location_factory' || $this->uri->segment(1) == '' ? 'class="active"' : '' ?> href="<?php echo base_url('ref_location_factory'); ?>">- Location Factory</a>
                            </li>
                            <li>
                                <a <?php echo $this->uri->segment(1) == 'ref_zone_division' || $this->uri->segment(1) == '' ? 'class="active"' : '' ?> href="<?php echo base_url('ref_zone_division'); ?>">- Zone Division</a>
                            </li>                          
                            <li>
                                <a <?php echo $this->uri->segment(1) == 'ref_area_zone' || $this->uri->segment(1) == '' ? 'class="active"' : '' ?> href="<?php echo base_url('ref_area_zone'); ?>">- Area Zone</a>
                            </li>
                            <li>
                                <a <?php echo $this->uri->segment(1) == 'ref_room_zone' || $this->uri->segment(1) == '' ? 'class="active"' : '' ?> href="<?php echo base_url('ref_room_zone'); ?>">- Room Area Zone</a>
                            </li>
                            <li>
