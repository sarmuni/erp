...
<div class="col-12">
    <div class="card mb-3">
        ...
        <div class="card-body">
            <!-- <a role="button" href="#" class="btn bg-danger" title="Add" data-toggle="modal" data-target=".tambah_sales_orders">
                <i class="fas fa-user-plus"></i>
            </a> -->
            <a role="button" href="<?php base_url(); ?>sales_orders/form" class="btn bg-danger btn-sm" title="Add New">
            ...
            <a role="button" href="<?php echo base_url('sales_orders'); ?>" class="btn bg-danger btn-sm" title="Refresh">
...
<!-- Modal Add -->
<div class="modal fade tambah_sales_orders" tabindex="-1" role="dialog" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form autocomplete="off" action="<?php echo base_url('sales_orders/add'); ?>" method="POST" enctype="multipart/form-data">
