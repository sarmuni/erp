...
<div class="col-12">
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <a role="button" href="#" class="btn bg-danger" title="Add Machinery" data-toggle="modal" data-target=".tambah_machinery"><i class="fas fa-user-plus"></i></a>

            <!-- <a role="button" href="#" class="btn bg-danger" title="Print">
                <i class="fas fa-print"></i>
            </a> -->

            <a role="button" href="<?php echo base_url('machinery'); ?>" class="btn bg-danger" title="Refresh">
                <i class="fas fa-sync-alt"></i>
            </a>

            <a role="button" href="#" class="btn bg-danger" title="Import Machinery" data-toggle="modal" data-target=".tambah_import"><i class="fas fa-file-import"></i></a>
                ...
                <table id="dataTable" class="table table-bordered table-hover display" style="width:100%">
                    ...
                    ?>
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td>
                                <a role="button" href="<?php echo site_url(); ?>machinery/view/<?php echo $row['id']; ?>" class="btn bg-info" title="View">
                            ...
                            <td>
                            <center>
                                    <a role="button" href="#" class="btn bg-danger" title="Edit" data-toggle="modal" data-target="#edit_machinery<?php echo $row['id']; ?>"><i class="fas fa-user-edit"></i>
                                    </a>
                                    <a role="button" href="<?php echo site_url(); ?>machinery/delete/<?php echo $row['id']; ?>" id="hapus" class="btn bg-danger tombol-hapus" title="Delete"><i class="fas fa-trash-alt"></i></a>
