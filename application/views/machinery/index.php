...
<div class="col-12">
    <div class="card mb-3">
        ...
        <div class="card-body">
            ...
            <!-- <a role="button" href="<?php echo base_url('machinery/form'); ?>" class="btn bg-danger" title="Create Machinery">
                <i class="fas fa-user-plus"></i>
            </a> -->

            <a role="button" href="#" class="btn bg-danger btn-sm" title="Add Machinery" data-toggle="modal" data-target=".tambah_machinery"><i class="fas fa-user-plus"></i> Add New</a>

            <!-- <a role="button" href="#" class="btn bg-danger" title="Print">
                <i class="fas fa-print"></i>
            </a> -->

            <a role="button" href="<?php echo base_url('machinery'); ?>" class="btn bg-danger btn-sm" title="Refresh">
                <i class="fas fa-sync-alt"></i> Refresh
            </a>

            <a role="button" href="#" class="btn bg-danger btn-sm" title="Import Machinery" data-toggle="modal" data-target=".tambah_import"><i class="fas fa-file-import"></i> Import Excel</a>
                ...
                <table id="dataTable" class="table table-bordered table-hover display" style="width:100%">
                    ...
                    ?>
                        <tr>
                            <td><?php echo $no; ?></td>
                            <td>
                                <a role="button" href="<?php echo site_url(); ?>machinery/view/<?php echo $row['id']; ?>" class="btn bg-info btn-sm" title="View">
                                <?php echo strtoupper($row['gln_mc_in']); ?>
                                </a>

                            </td>
                            <td><?php echo strtoupper($row['serial_number']); ?></td>
                            ...
                            <td>
                            <center>
                                    <a role="button" href="#" class="btn bg-warning btn-sm" title="Edit" data-toggle="modal" data-target="#edit_machinery<?php echo $row['id']; ?>"><i class="fas fa-user-edit"></i>
                                    </a>
                                    <a role="button" href="<?php echo site_url(); ?>machinery/delete/<?php echo $row['id']; ?>" id="hapus" class="btn bg-danger btn-sm tombol-hapus" title="Delete"><i class="fas fa-trash-alt"></i></a>
                                    
                                    <!-- <a role="button" href="#" class="btn bg-danger" title="More..." data-toggle="modal" data-target="#view_machinery<?php echo $row['id']; ?>"><i class="fab fa-searchengin"></i></a> -->
                            </center>
                            </td>
                        </tr>
                    <?php
...
<!-- Modal Add -->
<div class="modal fade tambah_machinery" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Form Add Machinery</h5>
                        ...
                        <form autocomplete="off" action="<?php echo base_url('machinery/add'); ?>" method="POST" enctype="multipart/form-data">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="gln_mc_in" readonly required class="form-control form-control-sm" id="gln_mc_in" value="<?php echo $gln_mc; ?>">
                                    <?= form_error('gln_mc_in', '<p style="color:red; font-size:12px;">', '</p>'); ?>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="serial_number">Serial Number</label>
                                    <input type="text" name="serial_number" required class="form-control form-control-sm" id="serial_number" value="<?= set_value('serial_number'); ?>">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="driver_id" name="driver_id" style="width: 500px !important" required class="form-control select2" value="<?= set_value('driver_id'); ?>">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="machinery_name" required class="form-control form-control-sm" id="machinery_name" value="<?= set_value('machinery_name'); ?>">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="net_weight" required class="form-control form-control-sm" id="net_weight" value="<?= set_value('net_weight'); ?>">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="supplier_id" name="supplier_id" style="width: 500px !important" required class="form-control select2" value="<?= set_value('supplier_id'); ?>">
                                        <option value="">--Select--</option>
...
?>
    <div class="modal fade edit_machinery" id="edit_machinery<?php echo $id; ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Form Edit Machinery</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form autocomplete="off" action="<?php echo base_url('machinery/edit/' . $id); ?>" method="POST" enctype="multipart/form-data">

                                <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="gln_mc_in">Global Location Number</label>
                                    <input type="text" name="gln_mc_in" readonly required class="form-control form-control-sm" id="gln_mc_in" value="<?php echo $gln_mc_in; ?>">
                                    <?= form_error('gln_mc_in', '<p style="color:red; font-size:12px;">', '</p>'); ?>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="serial_number">Serial Number</label>
                                    <input type="text" name="serial_number" required class="form-control form-control-sm" id="serial_number" value="<?php echo $serial_number; ?>">
                                    <?= form_error('serial_number', '<p style="color:red; font-size:12px;">', '</p>'); ?>
                                </div>
                            </div>
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="machinery_name">Machinery Name</label>
                                    <input type="text" name="machinery_name" required class="form-control form-control-sm" id="machinery_name" value="<?php echo $machinery_name; ?>">
                                    <?= form_error('machinery_name', '<p style="color:red; font-size:12px;">', '</p>'); ?>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="origin">Origin</label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="net_weight">Net Weight</label>
                                    <input type="text" name="net_weight" required class="form-control form-control-sm" id="net_weight" value="<?php echo $net_weight; ?>">
                                    <?= form_error('net_weight', '<p style="color:red; font-size:12px;">', '</p>'); ?>
                                </div>
                            </div>
...
<div class="modal fade tambah_import" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <form autocomplete="off" action="<?php echo base_url('machinery/import_excel'); ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- <div class="form-group col-md-12">
                                <label for="dokumen">Documents</label>
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="fileExcel" name="fileExcel" required="">
                                    <label class="custom-file-label" for="fileExcel">Choose
                                        file...</label>
                                    <div class="invalid-feedback">Example invalid custom file feedback</div>
                                </div>
                            </div> -->

                            <a role="button" href="<?php echo base_url(); ?>assets/machinery.xlsx" class="btn bg-danger btn-sm" title="Download Format Excel">Download Format Excel <i class="fa fa-download" aria-hidden="true"></i></a>
            ...
            <div class="modal-footer">
                <!-- <button type="submit" class="btn bg-danger btn-sm">Upload</button>
