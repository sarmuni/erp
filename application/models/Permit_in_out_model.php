...
class Permit_in_out_model extends MY_Model
{
    ...
    {
        $this->db->where('DAY(date_create)', $day);
    ...
    function get_all()
    {
        ...
        if ($role_id==1) {
            ...
            LEFT JOIN ref_personnel b ON a.`employee_name`=b.`person_id`";
        }else{
            $sql = "SELECT
            a.*,
            b.person_id,
    ...
    function get_permit_qrcode_id($qrcode_id)
    {
        $sql = "SELECT
        a.*,
        b.person_id,
