...
class Ref_rack_level_model extends MY_Model
{

    protected $table = 'ref_rack_level_detail';
    ...
    function get_all()
    {
        $sql = "SELECT 
        a.*,
        b.name AS name_rack_location
        FROM ref_rack_level_detail a
        LEFT JOIN ref_rack_location_detail b
        ON a.`id_rack_loc`=b.`id`";
