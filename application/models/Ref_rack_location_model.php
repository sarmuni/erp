...
class Ref_rack_location_model extends MY_Model
{

    protected $table = 'ref_rack_location_detail';
    ...
    function get_all()
    {
        ...
        a.*,
        b.name AS name_room
        FROM ref_rack_location_detail a
        LEFT JOIN ref_room_area_zone_detail b
        ON a.`area_room_id`=b.`id`";
