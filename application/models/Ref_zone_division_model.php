...
class Ref_zone_division_model extends MY_Model
{

    protected $table = 'ref_zone_division';
    ...
    function get_all()
    {
        $sql = "SELECT 
        a.*,
        b.name AS name_factory
        FROM ref_zone_division a
        LEFT JOIN ref_location_factory b
        ON a.`id_loc_fac`=b.`id`";
