...
class Rest_auth extends REST_Controller
{
    ...
    // http://localhost/erp/api/v1/rest_auth
    // http://localhost/erp/api/v1/rest_auth/user?id=1
    function user_get()
    {
        $id = $this->get('id');
        if ($id == '') {
    ...
    // http://localhost/erp/api/v1/rest_auth/registerasi
    ...
    // delete user metode delete parameter id form urlencode
    // http://localhost/erp/api/v1/rest_auth/user_delete?id=1
    function user_delete()
    {
        $id = $this->delete('id');
        $this->db->where('id', $id);
        $delete = $this->db->delete('auth_user');
        if ($delete) {
